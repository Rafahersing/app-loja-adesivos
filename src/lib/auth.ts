// src/lib/auth.ts (CONTEÚDO FINAL CORRIGIDO)

import { useState, useEffect } from 'react';
// ⭐️ CORREÇÃO: Importa o cliente Supabase do arquivo correto: utils.ts
...
export const useAuth = (): AuthContextType => {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            // Nota: O erro de Múltiplas instâncias no console foi corrigido
            // pela implementação Singleton em src/lib/utils.ts.
