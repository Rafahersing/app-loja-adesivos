...
  
  // Função para tratar a mudança de input mapeando os IDs do JSX para as chaves do FormData
...
    // A exclusão em 'produtos' deve cascatear para 'produtos_categorias' via Foreign Key (RLS)
...
          // Cria um ID temporário para relacionar o produto com a categoria
...
             // O slugify converte a string do nome/slug da planilha para o formato slug
...
        
        // Leitura do arquivo, começando da linha 1 (cabeçalhos)
...
      // Usa 'nome' e 'descricao' na pesquisa
